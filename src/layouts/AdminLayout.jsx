...
export const AdminLayout = () => {
  ...
  const adminNavItems = [
    ...
    { label: 'Active User Tracking', path: '/admin/active-users', icon: Activity },
  ...
  return (
    <div className="min-h-screen bg-zinc-100 flex flex-col font-sans text-zinc-900">
      {/* Top Banner Ticker */}
      <div className="bg-zinc-950 text-white text-xs px-4 py-2 flex items-center justify-between gap-2 border-b border-zinc-800">
      ...
      <div className="flex-1 flex relative">
        ...
        <aside className="hidden lg:flex flex-col w-64 bg-zinc-950 text-zinc-100 border-r border-zinc-900 shrink-0 select-none">
          ...
          <div className="p-5 border-b border-zinc-900 flex items-center gap-3">
            <img src="/logo.png" alt="Referitup Logo" className="w-8 h-8 rounded-md bg-white p-0.5 object-contain shrink-0" />
            <div>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <footer className="border-t border-zinc-200 bg-white py-4 px-6 text-center text-xs text-zinc-500 font-medium mt-auto">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 max-w-7xl mx-auto">
              <div>
                © {new Date().getFullYear()} <span className="font-bold text-zinc-900">Referitup</span> Admin Console. All rights reserved.
              </div>
              <div>
